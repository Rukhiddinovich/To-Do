...
import 'package:todo_task/utils/colors_function/colors_function.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                blue("${widget.day.day}.${widget.day.month}", events)
                    ? SvgPicture.asset(AppIcons.blue)
                    : const SizedBox(),
                4.pw,
                red("${widget.day.day}.${widget.day.month}", events)
                    ? SvgPicture.asset(AppIcons.red)
                    : const SizedBox(),
                4.pw,
                orange("${widget.day.day}.${widget.day.month}", events)
                    ? SvgPicture.asset(AppIcons.orange)
                    : const SizedBox(),
              ],
            )
          ],
